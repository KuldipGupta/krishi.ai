# short_term.py
# Stores conversation history in a Python dictionary (RAM)
# Fast, simple, zero setup
# Limitation: resets when server restarts
# We upgrade this to Supabase on Day 7
